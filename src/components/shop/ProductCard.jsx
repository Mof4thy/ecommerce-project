    ...
    return (
        ...
        <div className="border border-gray-200 px-2 sm:px-4 py-3 sm:py-4 rounded-md flex flex-col gap-2 h-full w-full">
            ...
            <div className="flex flex-col gap-1 flex-grow">
                <h2 className="text-sm sm:text-lg font-semibold min-h-[40px] sm:min-h-[60px] line-clamp-2">{product.name}</h2>
            ...
            <div className="flex border border-gray-200 rounded-xl sm:rounded-2xl justify-between items-center gap-1 sm:gap-2 overflow-hidden mt-auto">
                <span className="px-2 sm:px-3 py-1 sm:py-2 bg-gray-200 cursor-pointer hover:bg-gray-300 transition-colors"> <Minus size={14} className="sm:w-[18px] sm:h-[18px]" /> </span>
                <span className="text-xs sm:text-sm font-bold text-black min-w-[20px] text-center"> 2 </span>
                <span className="px-2 sm:px-3 py-1 sm:py-2 bg-[#FFCD00] cursor-pointer hover:bg-yellow-400 transition-colors"> <Plus size={14} className="sm:w-[18px] sm:h-[18px]" /> </span> 
            </div>
        </div>
    )
})
